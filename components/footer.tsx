      ...
      <div className="relative mx-auto max-w-6xl px-6 py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-10 md:gap-8">
          ...
          <div className="col-span-2">
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="w-9 h-9 rounded-lg bg-secondary/80 flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-secondary transition-all duration-200">
          ...
          {/* Product */}
          <div>
            <h3 className="text-[13px] font-semibold mb-5 tracking-wide">{t("footer.product")}</h3>
            <ul className="space-y-3">
              {links.product.map((link, i) => (
                <li key={i}>
                  <a href={link.href} className="text-[14px] text-muted-foreground hover:text-foreground transition-colors">
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          {/* Resources */}
          <div>
            <h3 className="text-[13px] font-semibold mb-5 tracking-wide">{t("footer.resources")}</h3>
            <ul className="space-y-3">
          ...
          {/* Company */}
          <div>
            <h3 className="text-[13px] font-semibold mb-5 tracking-wide">{t("footer.company")}</h3>
            <ul className="space-y-3">
          ...
          {/* Legal */}
          <div>
            <h3 className="text-[13px] font-semibold mb-5 tracking-wide">{t("footer.legal")}</h3>
            <ul className="space-y-3">
        ...
        <div className="mt-16 pt-8 border-t border-border/50 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[13px] text-muted-foreground">
            © {new Date().getFullYear()} oftab. {t("footer.copyright")}
          </p>
